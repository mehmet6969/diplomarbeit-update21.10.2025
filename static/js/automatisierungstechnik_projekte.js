...
function App() {
    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                const res = await fetch("/api/projects?module=automat", {
    ...
    const addProject = async (newProject) => {
        try {
            const res = await fetch("/api/projects", {
                ...
                body: JSON.stringify({ ...newProject, module: "automat" }),
            });
            ...
            <nav id="navbar">
                <div className="nav-content">
                    ...
                    <ul className="nav-links">
                        ...
                        <li><a href="/automatisierungstechnik_info" className="nav-link">Info</a></li>
                        <li>
